...
OWNER_ID = int(getenv("OWNER_ID", "7831196476"))
OWNER_USERNAME = getenv("OWNER_USERNAME", None)
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "7159158466").split()))
ALIVE_PIC = getenv("ALIVE_PIC", "https://files.catbox.moe/x3i6mc.jpeg")
...
USERBOT_PICTURE = getenv("USERBOT_PICTURE", "https://files.catbox.moe/x3i6mc.jpeg")
